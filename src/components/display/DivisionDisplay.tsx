      ...
      <div className="sticky top-0 z-10 bg-gradient-to-b from-black via-black to-transparent pb-8 pt-4">
        <div className="relative flex items-center justify-center">
          <Image
            ...
            width={80}
            height={80}
            className="absolute left-0 h-8 xs:h-10 sm:h-16 md:h-20 w-auto"
            priority
          />
          <motion.h2
            initial={{ opacity: 0 }}
            animate={{ opacity: isVisible ? 1 : 0 }}
            transition={{ duration: 0.5 }}
            className="font-sport-solid text-xl xs:text-2xl sm:text-5xl md:text-7xl tracking-[0.25em] px-10 xs:px-12 sm:px-20 md:px-24 font-normal underline decoration-2 sm:decoration-4 underline-offset-4 sm:underline-offset-8 text-white"
          >
          ...
          <Image
            ...
            width={80}
            height={80}
            className="absolute right-0 h-8 xs:h-10 sm:h-16 md:h-20 w-auto -scale-x-100"
            priority
          />
        </div>
      </div>
